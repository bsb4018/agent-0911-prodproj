...
class DatabaseService:
    ...
    def __init__(self):
        ...
        try:
            # Configure environment-specific database connection pool configs
            pool_size = configs.POSTGRES_POOL_SIZE
            max_overflow = configs.POSTGRES_MAX_OVERFLOW

            # Create engine with appropriate pool configuration
            connection_url = (
                f"postgresql://{configs.POSTGRES_USER}:{configs.POSTGRES_PASSWORD}"
            ...
            logger.error("database_initialization_error", error=str(e), environment=configs.ENVIRONMENT.value)
